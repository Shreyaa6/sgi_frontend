      ...
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-logo-section">
            <img src={logoImage} alt="Sri Gangotri Industries Logo" className="footer-logo" />
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#nursery">Nursery & Plants</a></li>
          ...
          <div className="footer-newsletter">
            <h3 className="footer-column-title">JOIN OUR COMMUNITY</h3>
        ...
        <div className="footer-brand">
          <h2 className="footer-brand-name">SRI GANGOTRI INDUSTRIES</h2>
        </div>
